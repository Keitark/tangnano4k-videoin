...
set build_root [file join $repo_root build cvbs_hdmi_diag_runtime_all_codes_c6]
...
add_file -type verilog [file join $repo_root rtl cvbs delta_modulator_runtime_core.v]
add_file -type verilog [file join $repo_root rtl cvbs lvds_delta_adc_runtime.v]
...
add_file -type verilog [file join $repo_root rtl top nano4k_cvbs_hdmi_diag_runtime_sweep.v]
add_file -type cst [file join $repo_root constraints nano4k_cvbs_hdmi_diag.cst]
add_file -type sdc [file join $repo_root constraints nano4k_cvbs_hdmi_diag_runtime_sweep.sdc]

set_option -synthesis_tool gowinsynthesis
set_option -top_module nano4k_cvbs_hdmi_diag_runtime_sweep
