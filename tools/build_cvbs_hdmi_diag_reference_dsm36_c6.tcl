...
set build_root [file join $repo_root build cvbs_hdmi_diag_reference_dsm36_c6]
...
add_file -type verilog [file join $repo_root rtl top nano4k_cvbs_hdmi_diag_reference_dsm36.v]
...
set_option -top_module nano4k_cvbs_hdmi_diag_reference_dsm36
