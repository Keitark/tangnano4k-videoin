...
set build_root [file join $repo_root build cvbs_hdmi_diag_c6]
...
add_file -type verilog [file join $repo_root rtl cvbs adc_loop_stats_monitor.v]
...
set_option -top_module nano4k_cvbs_hdmi_diag
