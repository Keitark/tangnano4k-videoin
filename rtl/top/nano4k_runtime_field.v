// Source vertical alignment on the verified narrow-band runtime architecture.
module nano4k_runtime_field (
    ...
    nano4k_ntsc_hdmi #(.RUNTIME_PROBE(1),.SOURCE_FIELD_SYNC(1)) core (
