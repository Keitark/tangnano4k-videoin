// Continuous color viewing build; A/B and previous trial tops remain available.
module nano4k_line320_color (
    ...
    nano4k_ntsc_hdmi #(.SOURCE_FIELD_SYNC(1), .COLOR_OUTPUT(1), .CLEAN_CHROMA(3),
