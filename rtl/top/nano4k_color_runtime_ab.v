// Full color engine remains synthesized; only its pixel selection alternates.
module nano4k_color_runtime_ab (
    ...
    nano4k_ntsc_hdmi #(.RUNTIME_PROBE(1), .PROBE_CYCLE_ONCE(1),
        .SOURCE_FIELD_SYNC(1), .FRAME_WIDTH(80), .COLOR_OUTPUT(1), .RUNTIME_COLOR(1)) core (
